...
{
    private string connectionString = "User ID=sa;password=examlyMssql@123;server=dffafdafebcfacbdcbaeadbebabcdebdca-0;Database=carserviceDB;trusted_connection=false;Persist Security Info=False;Encrypt=False";
                ...
                if (!string.IsNullOrEmpty(sortOrder))
                {
                    ...
                    switch (sortOrder)
                    {
                        ...
                        case "appointment_date":
                            query += "appointment_date DESC"; // Assuming you have an appointment_date column
                            break;
                        default:
